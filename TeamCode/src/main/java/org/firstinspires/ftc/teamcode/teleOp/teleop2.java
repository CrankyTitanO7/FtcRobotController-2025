...
//        telemetry.addData("DS preview on/off", "3 dots, Camera Stream");
        ...
        while (opModeIsActive()) {
            ...
            dosaction = twocntrl.dosido(gamepad2.left_trigger, gamepad2.right_trigger, clawOpen, clawOpen2, gamepad2.left_stick_x, gamepad2.right_stick_y, 0.5, 0.1, .2, gamepad2.right_stick_x, gamepad2.left_stick_y);
